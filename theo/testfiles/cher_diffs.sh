...
diffs=("diff my_tests/good-01/index.html testOutput/good-01/index.html" \
	...
	"grep 'Server: Cherokee/1.2.101 (UNIX)' my_tests/good-07/index.html" \
	"grep 'Content-Length: 574' my_tests/good-08/index.html" \
...
echo "Server: Cherokee/1.2.101 (UNIX)"
echo "Content-Length: 574"
echo "----------------------------------"
echo "Output:"
echo ""
