...
entry:
  ;jikk - step 1. init. %test_var
  %test_var = alloca i1, align 4
  store i1 0, i1* %test_var
...
check_malloc:
  call void @__ubsan_handle_check_malloc() #2
  br label %cont0
...
; Function Attrs: uwtable
declare void @__ubsan_handle_check_malloc() #2
